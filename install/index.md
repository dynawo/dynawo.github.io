...
| Detailed release note | [v1.3.0_release_note.txt](https://github.com/dynawo/dynawo/releases/download/v1.3.0/v1.3.0_release_note.txt) |
...
Official Windows-based release is available [here](https://github.com/dynawo/dynawo/releases/download/v1.3.0/Dynawo_Windows_v1.3.0.zip).
