...
The latest release is [Dyna&omega;o v1.3.2]({{ '/release_note' }}) and could be retrieved using the following links:

|---|---|
| Linux distribution | [Dynawo_Linux_v1.3.2.zip](https://github.com/dynawo/dynawo/releases/download/v1.3.2/Dynawo_Linux_v1.3.2.zip) |
| Windows distribution (VS2019) | [Dynawo_Windows_v1.3.2.zip](https://github.com/dynawo/dynawo/releases/download/v1.3.2/Dynawo_Windows_v1.3.2.zip) |
| Documentation | [DynawoDocumentation.zip](https://github.com/dynawo/dynawo/releases/download/v1.3.2/DynawoDocumentation.zip) |
| Dynawo Modelica library | [Dynawo_Modelica_library_v1.3.2.zip](https://github.com/dynawo/dynawo/releases/download/v1.3.2/Dynawo_Modelica_library_V1.3.2.zip) |
| Detailed release note | [v1.3.2_release_note.txt](https://github.com/dynawo/dynawo/releases/download/v1.3.2/v1.3.2_release_note.txt) |
...
Official Linux-based release is available [here](https://github.com/dynawo/dynawo/releases/download/v1.3.2/Dynawo_Linux_v1.3.2.zip).
...
Official Windows-based release is available [here](https://github.com/dynawo/dynawo/releases/download/v1.3.2/Dynawo_Windows_v1.3.2.zip).
